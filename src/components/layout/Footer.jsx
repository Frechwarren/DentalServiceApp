...
const Footer = () => {
  return (
    <footer id="contactInfo" className="bg-gray-900 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Providing quality dental care services for your family's health
              and well-being.
            </p>
          </div>
